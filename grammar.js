...
var grammar = {
    ...
    {"name": "location", "symbols": ["between", "entity", "and", "entity"], "postprocess": R({relation:0, entity:2})},
    ...
    {"name": "is_there$string$1", "symbols": [{"literal":"i"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "is_there$string$2", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "is_there", "symbols": ["is_there$string$1", "is_there$string$2"]}
]
  , ParserStart: "main"
}
